...
module.exports = function (server, db) {
    ...
    server.get("/data/settings/:password", async (req: express.Request, res: express.Response) => {
        try {
            const user = await db.prepare(" password FROM user WHERE password = @password").get(req.params);
