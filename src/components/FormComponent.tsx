...
{/*               <button
                type="submit"
                className="text-blue-500 bg-gray-700 group relative flex w-full justify-center rounded-md border border-transparent py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              >
            ...
            <div className="text-sm">
                <a
                  href="#"
                  className="px-7 py-2 text-blue-700 ml-40 bg-transparent"
                >
                  Register
                </a>
              </div>
