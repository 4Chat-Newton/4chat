...
export default function Register() {
  ...
  const [usernameAlreadySelected, onUsernameSelection] = useState(false);
  ...
  const connectUserToSocket = (username:any) => {
  ...
  const handleSubmit = async () => {
    if (password === confirmPassword && acceptTerms) {
      ...
      alert(
        "To register an account, you need to accept the Terms & Conditions!"
      );
    }
  };
      ...
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <button
              className="bg-gray-700 px-6 py-2 text-blue-700 ml-40"
              type="submit"
              name="submit_btn"
              id="submit_btn"
